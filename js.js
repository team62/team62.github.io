          ...
          for (i = 0; i < jd.size; i++) {
            ...
            for (i = 0; i < jd.size; i++) {
                if (jd.result[i].scored == 1) {
                    ...
                    if(r1==teamNumber)
                    	r1='<b style="font-weight:bold;">'+r1+'</b>';
                    if(r2==teamNumber)
                    	r2='<b style="font-weight:bold;">'+r2+'</b>';
                    if(r3==teamNumber)
                    	r3='<b style="font-weight:bold;">'+r3+'</b>';
                    if(b1==teamNumber)
                    	b1='<b style="font-weight:bold;">'+b1+'</b>';
                    if(b2==teamNumber)
                    	b2='<b style="font-weight:bold;">'+b2+'</b>';
                    if(b3==teamNumber)
                    	b3='<b style="font-weight:bold;">'+b3+'</b>';
