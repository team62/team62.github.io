$(document).ready(function () {
    ...
    $.getJSON('http://team62.github.io/rankings.json', function (jd) { //replace with full rankings api search for sku
        for (i = 0; i < 3; i++) {
    ...
    $.getJSON('http://team62.github.io/62rankings.json', function (jd) { //replace with ranking api, search for team 62 and sku
        $('#us').append('<td>-</td>');
